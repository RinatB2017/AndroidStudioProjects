...
public final class R {
  ...
  public static final class id {
    ...
    public static final int logTextView=0x7f05001e;
  ...
  public static final class styleable {
     ...
     * <tr><td><code>{@link #ColorStateListItem_alpha ru.learn2prog.usbhostexample:alpha}</code></td><td>Alpha multiplier applied to the base color.</td></tr>
     * </table>
     ...
     * <p>May be a floating point value, such as "<code>1.2</code>".
     *
     * @attr name ru.learn2prog.usbhostexample:alpha
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #CoordinatorLayout_keylines ru.learn2prog.usbhostexample:keylines}</code></td><td>A reference to an array of integers representing the
     * locations of horizontal keylines in dp from the starting edge.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_statusBarBackground ru.learn2prog.usbhostexample:statusBarBackground}</code></td><td>Drawable to display behind the status bar when the view is set to draw behind it.</td></tr>
     * </table>
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name ru.learn2prog.usbhostexample:keylines
     */
     ...
     * "<code>#<i>aarrggbb</i></code>".
     *
     * @attr name ru.learn2prog.usbhostexample:statusBarBackground
     */
     ...
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_anchor ru.learn2prog.usbhostexample:layout_anchor}</code></td><td>The id of an anchor view that this view should position relative to.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_anchorGravity ru.learn2prog.usbhostexample:layout_anchorGravity}</code></td><td>Specifies how an object should position relative to an anchor, on both the X and Y axes,
     * within its parent's bounds.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_behavior ru.learn2prog.usbhostexample:layout_behavior}</code></td><td>The class name of a Behavior class defining special runtime behavior
     * for this child view.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_dodgeInsetEdges ru.learn2prog.usbhostexample:layout_dodgeInsetEdges}</code></td><td>Specifies how this view dodges the inset edges of the CoordinatorLayout.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_insetEdge ru.learn2prog.usbhostexample:layout_insetEdge}</code></td><td>Specifies how this view insets the CoordinatorLayout and make some other views
     * dodge it.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_keyline ru.learn2prog.usbhostexample:layout_keyline}</code></td><td>The index of a keyline this view should position relative to.</td></tr>
     * </table>
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name ru.learn2prog.usbhostexample:layout_anchor
     */
     ...
     * </table>
     *
     * @attr name ru.learn2prog.usbhostexample:layout_anchorGravity
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name ru.learn2prog.usbhostexample:layout_behavior
     */
     ...
     * </table>
     *
     * @attr name ru.learn2prog.usbhostexample:layout_dodgeInsetEdges
     */
     ...
     * </table>
     *
     * @attr name ru.learn2prog.usbhostexample:layout_insetEdge
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name ru.learn2prog.usbhostexample:layout_keyline
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderAuthority ru.learn2prog.usbhostexample:fontProviderAuthority}</code></td><td>The authority of the Font Provider to be used for the request.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderCerts ru.learn2prog.usbhostexample:fontProviderCerts}</code></td><td>The sets of hashes for the certificates the provider should be signed with.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderFetchStrategy ru.learn2prog.usbhostexample:fontProviderFetchStrategy}</code></td><td>The strategy to be used when fetching font data from a font provider in XML layouts.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderFetchTimeout ru.learn2prog.usbhostexample:fontProviderFetchTimeout}</code></td><td>The length of the timeout during fetching.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderPackage ru.learn2prog.usbhostexample:fontProviderPackage}</code></td><td>The package for the Font Provider to be used for the request.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderQuery ru.learn2prog.usbhostexample:fontProviderQuery}</code></td><td>The query to be sent over to the provider.</td></tr>
     * </table>
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name ru.learn2prog.usbhostexample:fontProviderAuthority
     */
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name ru.learn2prog.usbhostexample:fontProviderCerts
     */
     ...
     * </table>
     *
     * @attr name ru.learn2prog.usbhostexample:fontProviderFetchStrategy
     */
     ...
     * </table>
     *
     * @attr name ru.learn2prog.usbhostexample:fontProviderFetchTimeout
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name ru.learn2prog.usbhostexample:fontProviderPackage
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name ru.learn2prog.usbhostexample:fontProviderQuery
     */
     ...
     * <tr><td><code>{@link #FontFamilyFont_font ru.learn2prog.usbhostexample:font}</code></td><td>The reference to the font file to be used.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontStyle ru.learn2prog.usbhostexample:fontStyle}</code></td><td>The style of the given font file.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontVariationSettings ru.learn2prog.usbhostexample:fontVariationSettings}</code></td><td>The variation settings to be applied to the font.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontWeight ru.learn2prog.usbhostexample:fontWeight}</code></td><td>The weight of the given font file.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_ttcIndex ru.learn2prog.usbhostexample:ttcIndex}</code></td><td>The index of the font in the tcc font file.</td></tr>
     * </table>
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name ru.learn2prog.usbhostexample:font
     */
     ...
     * </table>
     *
     * @attr name ru.learn2prog.usbhostexample:fontStyle
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name ru.learn2prog.usbhostexample:fontVariationSettings
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name ru.learn2prog.usbhostexample:fontWeight
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name ru.learn2prog.usbhostexample:ttcIndex
     */
