...
class World {
    ...
    void test_draw() {
        ...
        c_bitmap.drawRect(50, 30, 140, 16, mPaint);
        mPaint.setColor(Color.BLACK);
        c_bitmap.drawText("Generation: " + String.valueOf(generation), 54, 44, mPaint);
    }
    ...
    void work() {
        ...
        for (int y = 0; y < height; y++) {
            for (int x = 0; x < width; x++) {
                if (matrix[x][y] == null) {
                    mPaint.setColor(Color.WHITE);
                    c_bitmap.drawRect(50 + x * 4, 50 + y * 4, 4, 4, mPaint);
                    ...
                    c_bitmap.drawRect(50 + x * 4 + 1, 50 + y * 4 + 1, 3, 3, mPaint);
        ...
        mPaint.setColor(Color.WHITE);
        c_bitmap.drawRect(200, 30, 140, 16, mPaint);
        mPaint.setColor(Color.BLACK);
        c_bitmap.drawText("Population: " + String.valueOf(population), 204, 44, mPaint);

        mPaint.setColor(Color.WHITE);
        c_bitmap.drawRect(350, 30, 140, 16, mPaint);
        mPaint.setColor(Color.BLACK);
        c_bitmap.drawText("Organic: " + String.valueOf(organic), 354, 44, mPaint);
    }
